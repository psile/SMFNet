...
#   指向了验证集标签与图片路径
#-------------------------------------------------------#
cocoGt_path         = '/home/public/S_DAUB/60_coco_val.json' #instances_test2017.json 100_coco_val.json
dataset_img_path    = '/home/public/S_DAUB/'
...
if __name__ == "__main__":
    ...
    if map_mode == 0 or map_mode == 2:
        ...
        print("Get map done.")
        with open("YOLO_result.txt", 'w') as f:
